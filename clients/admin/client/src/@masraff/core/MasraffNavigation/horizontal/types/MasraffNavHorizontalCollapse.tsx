...
import {Grow, IconButton, ListItemButton, ListItemText, Paper} from "@mui/material";
...
const StyledListItem = styled(ListItemButton as any)(({theme}: any) => ({
