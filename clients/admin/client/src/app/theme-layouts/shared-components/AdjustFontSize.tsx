...
import {IconButton, Menu, Slider, Typography} from "@mui/material";
...
const AdjustFontSize = (props: any) => {
    ...
    return (
        <div>
            <IconButton
                ...
                size="large"
            >
                <MasraffSvgIcon>material-outline:format_size</MasraffSvgIcon>
            </IconButton>
            <Menu
                classes={{ paper: 'w-320' }}
                id="font-size-menu"
            ...
            >
                <div className="py-12 px-24">
                    <Typography className="flex items-center justify-center text-16 font-semibold mb-8">
                        <MasraffSvgIcon color="action" className="mr-4">
                    ...
                    <Slider
                        ...
                        onChange={(ev, value: any) => setFontSize(value)}
